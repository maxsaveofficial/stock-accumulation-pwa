...
const files:any={'/':'index.html','/index.html':'index.html','/styles.css':'styles.css','/analysis.js':'analysis.js','/data-provider.js':'data-provider.js','/calibration.js':'calibration.js','/app.js':'app.js','/manifest.webmanifest':'manifest.webmanifest','/icon.svg':'icon.svg','/icon-180.png':'icon-180.png','/icon-192.png':'icon-192.png','/apple-touch-icon.png':'apple-touch-icon.png','/sw.js':'sw.js','/csv-status.js':'csv-status.js'};
