  ...
  setTimeout(()=>{
    ...
    try{
      ...
      setTimeout(async()=>{
        ...
        const box=$('backtest');
        box.innerHTML=`<div class="btchart btcompact"><div class="bt5title"><span>Donut = net return · walk-forward · biaya 1%</span></div><div class="btdonutwrap"><svg id="btDonut" viewBox="0 0 180 180" aria-label="Backtest horizons"><circle cx="90" cy="90" r="62" class="btdonutbase"></circle><g id="btDonutSegs"></g></svg><div class="btdonutcenter"><b id="btBestT">—</b><span id="btBestRet">menghitung</span></div></div><div class="btstats" id="btstats"></div><div class="btlegend"><span>Segmen makin besar = return makin tinggi</span><em>Net return · asumsi biaya 1% per signal</em></div></div>`;
        ...
        for(const h of horizons){
          ...
          try{
            const x=window.StockFlowCalibration?.walkForward(btPool,{lookback:lb,horizon:h,costPct:1});
            await update(h,x);
          }catch(err){
